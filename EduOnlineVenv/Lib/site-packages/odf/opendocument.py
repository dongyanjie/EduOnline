...
odmimetypes = {
 ...
 u'application/vnd.oasis.opendocument.images':                 u'.odi',
 u'application/vnd.oasis.opendocument.images-template':        u'.oti',
...
class OpenDocument:
    ...
    def addPictureFromFile(self, filename, mediatype=None):
        ...
        extension.
        @param filesname unicode string: name of an images file
    ...
    def addPictureFromString(self, content, mediatype):
        ...
        is a string that contains the binary images data. The mediatype
        indicates the images format.
...
def OpenDocumentImage():
    """
    Creates an images document
    @return an OpenDocument instance with images mimetype
    """
    doc = OpenDocument(u'application/vnd.oasis.opendocument.images')
    doc.image = Image()
...
def load(odffile):
    ...
    elif mimetype[:40] == u'application/vnd.oasis.opendocument.images':
