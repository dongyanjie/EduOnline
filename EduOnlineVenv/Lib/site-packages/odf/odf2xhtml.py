...
class StyleToCSS:
    ...
    def __init__(self):
        ...
        self.ruleconversions = {
            (DRAWNS,u'fill-images-name'): self.c_drawfillimage,
    ...
    def c_drawfillimage(self, ruleset, sdict, rule, val):
        """ Fill a figure with an images. Since CSS doesn't let you resize images
            this should really be implemented as an absolutely position <img>
            with a width and a height
        """
        sdict['background-images'] = "url('%s')" % self.fillimages[val]
...
class ODF2XHTML(handler.ContentHandler):
    ...
    def __init__(self, generate_css=True, embedable=False):
        ...
        (DRAWNS, 'images'): (self.s_draw_image, None),
        (DRAWNS, 'fill-images'): (self.s_draw_fill_image, None),
...
#-----------------------------------------------------------------------------
    ...
    def s_draw_image(self, tag, attrs):
        """ A <draw:images> becomes an <img/> element
        """
