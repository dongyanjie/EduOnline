...
#	((DBNS,u'type'), None): cnv_namespacedToken,
	...
	((DRAWNS,u'fill-images-height'), None): cnv_lengthorpercent,
	((DRAWNS,u'fill-images-name'), None): cnv_DrawNameRef,
	((DRAWNS,u'fill-images-ref-point'), None): cnv_string,
	((DRAWNS,u'fill-images-ref-point-x'), None): cnv_string,
	((DRAWNS,u'fill-images-ref-point-y'), None): cnv_string,
	((DRAWNS,u'fill-images-width'), None): cnv_lengthorpercent,
...
#	((DRAWNS,u'id'), None): cnv_nonNegativeInteger,   # ?? line 6581 in RNG
	...
	((DRAWNS,u'images-opacity'), None): cnv_string,
...
#	((FORMNS,u'current-value'), None): cnv_time,
	...
	((FORMNS,u'images-align'), None): cnv_string,
	((FORMNS,u'images-data'), None): cnv_anyURI,
	((FORMNS,u'images-position'), None): cnv_string,
...
#	((FORMNS,u'value'), None): cnv_time,
	...
	((METANS,u'images-count'), None): cnv_nonNegativeInteger,
