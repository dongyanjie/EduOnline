...
# allowed_children
	...
	(TEXTNS,u'list-level-style-images') : (
		(OFFICENS,u'binary-data'),
		(STYLENS,u'list-level-properties'),
	),
...
# allowed_attributes
	(STYLENS,u'drawing-page-properties'): (
		...
		(DRAWNS,u'fill-images-name'),
		(STYLENS,u'repeat'),
		(DRAWNS,u'fill-images-width'),
		(DRAWNS,u'fill-images-height'),
		(DRAWNS,u'fill-images-ref-point-x'),
		(DRAWNS,u'fill-images-ref-point-y'),
		(DRAWNS,u'fill-images-ref-point'),
